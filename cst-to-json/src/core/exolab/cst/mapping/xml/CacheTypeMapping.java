...
public class CacheTypeMapping implements java.io.Serializable {
     ...
     * @param vParam
     */
    public void addParam(core.exolab.cst.mapping.xml.Param vParam)
     ...
     * @param vParam
     */
    public void addParam(int index, core.exolab.cst.mapping.xml.Param vParam)
        throws java.lang.IndexOutOfBoundsException
    {
     ...
     * @return Param
     */
    public core.exolab.cst.mapping.xml.Param getParam(int index)
        throws java.lang.IndexOutOfBoundsException
    {
        ...
        return (core.exolab.cst.mapping.xml.Param) _paramList.get(index);
     ...
     * @return Param
     */
    public core.exolab.cst.mapping.xml.Param[] getParam()
    {
        int size = _paramList.size();
        core.exolab.cst.mapping.xml.Param[] mArray = new core.exolab.cst.mapping.xml.Param[size];
        for (int index = 0; index < size; index++) {
            mArray[index] = (core.exolab.cst.mapping.xml.Param) _paramList.get(index);
        }
        return mArray;
     ...
     * @return boolean
     */
    public boolean removeParam(core.exolab.cst.mapping.xml.Param vParam)
    {
     ...
     * @param vParam
     */
    public void setParam(int index, core.exolab.cst.mapping.xml.Param vParam)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        if ((index < 0) || (index >= _paramList.size())) {
     ...
     * @param paramArray
     */
    public void setParam(core.exolab.cst.mapping.xml.Param[] paramArray)
    {
        //-- copy array
        _paramList.clear();
     ...
     */
    public static core.exolab.cst.mapping.xml.CacheTypeMapping unmarshal(java.io.Reader reader)
        throws core.exolab.cst.xml.MarshalException, core.exolab.cst.xml.ValidationException
    {
        return (core.exolab.cst.mapping.xml.CacheTypeMapping) Unmarshaller.unmarshal(core.exolab.cst.mapping.xml.CacheTypeMapping.class, reader);
