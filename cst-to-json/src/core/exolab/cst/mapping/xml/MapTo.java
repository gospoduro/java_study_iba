...
public class MapTo implements java.io.Serializable {
     ...
     * @return MapTo
     */
    public static core.exolab.cst.mapping.xml.MapTo unmarshal(java.io.Reader reader)
        throws core.exolab.cst.xml.MarshalException, core.exolab.cst.xml.ValidationException
    {
        return (core.exolab.cst.mapping.xml.MapTo) Unmarshaller.unmarshal(core.exolab.cst.mapping.xml.MapTo.class, reader);
