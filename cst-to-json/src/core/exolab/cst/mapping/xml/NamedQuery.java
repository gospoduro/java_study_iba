...
public class NamedQuery implements java.io.Serializable {
     ...
     * @param vQueryHint
     */
    public void addQueryHint(core.exolab.cst.mapping.xml.QueryHint vQueryHint)
     ...
     * @param vQueryHint
     */
    public void addQueryHint(int index, core.exolab.cst.mapping.xml.QueryHint vQueryHint)
        throws java.lang.IndexOutOfBoundsException
    {
     ...
     * @return QueryHint
     */
    public core.exolab.cst.mapping.xml.QueryHint getQueryHint(int index)
        throws java.lang.IndexOutOfBoundsException
    {
        ...
        return (core.exolab.cst.mapping.xml.QueryHint) _queryHintList.get(index);
     ...
     * @return QueryHint
     */
    public core.exolab.cst.mapping.xml.QueryHint[] getQueryHint()
    {
        int size = _queryHintList.size();
        core.exolab.cst.mapping.xml.QueryHint[] mArray = new core.exolab.cst.mapping.xml.QueryHint[size];
        for (int index = 0; index < size; index++) {
            mArray[index] = (core.exolab.cst.mapping.xml.QueryHint) _queryHintList.get(index);
        }
        return mArray;
     ...
     * @return boolean
     */
    public boolean removeQueryHint(core.exolab.cst.mapping.xml.QueryHint vQueryHint)
    {
     ...
     * @param vQueryHint
     */
    public void setQueryHint(int index, core.exolab.cst.mapping.xml.QueryHint vQueryHint)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        if ((index < 0) || (index >= _queryHintList.size())) {
     ...
     */
    public void setQueryHint(core.exolab.cst.mapping.xml.QueryHint[] queryHintArray)
    {
        //-- copy array
        _queryHintList.clear();
     ...
     * @return NamedQuery
     */
    public static core.exolab.cst.mapping.xml.NamedQuery unmarshal(java.io.Reader reader)
        throws core.exolab.cst.xml.MarshalException, core.exolab.cst.xml.ValidationException
    {
        return (core.exolab.cst.mapping.xml.NamedQuery) Unmarshaller.unmarshal(core.exolab.cst.mapping.xml.NamedQuery.class, reader);
