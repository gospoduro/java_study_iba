...
public class ClassMapping implements java.io.Serializable {
     ...
     * Field _access
     */
    private core.exolab.cst.mapping.xml.types.ClassMappingAccessType _access = core.exolab.cst.mapping.xml.types.ClassMappingAccessType.valueOf("shared");
     ...
     */
    private core.exolab.cst.mapping.xml.CacheTypeMapping _cacheTypeMapping;

    /**
     * Field _mapTo
     */
    private core.exolab.cst.mapping.xml.MapTo _mapTo;
     ...
     * Field _classChoice
     */
    private core.exolab.cst.mapping.xml.ClassChoice _classChoice;
    ...
    public ClassMapping() 
     {
        ...
        setAccess(core.exolab.cst.mapping.xml.types.ClassMappingAccessType.valueOf("shared"));
     ...
     * @param vNamedQuery
     */
    public void addNamedQuery(core.exolab.cst.mapping.xml.NamedQuery vNamedQuery)
        throws java.lang.IndexOutOfBoundsException
    {
     ...
     * @param vNamedQuery
     */
    public void addNamedQuery(int index, core.exolab.cst.mapping.xml.NamedQuery vNamedQuery)
        throws java.lang.IndexOutOfBoundsException
    {
     ...
     */
    public core.exolab.cst.mapping.xml.types.ClassMappingAccessType getAccess()
    {
        return this._access;
     ...
     */
    public core.exolab.cst.mapping.xml.CacheTypeMapping getCacheTypeMapping()
    {
     ...
     */
    public core.exolab.cst.mapping.xml.ClassChoice getClassChoice()
    {
     ...
     */
    public core.exolab.cst.mapping.xml.MapTo getMapTo()
    {
        return this._mapTo;
     ...
     * @return NamedQuery
     */
    public core.exolab.cst.mapping.xml.NamedQuery getNamedQuery(int index)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        ...
        return (core.exolab.cst.mapping.xml.NamedQuery) _namedQueryList.get(index);
     ...
     * @return NamedQuery
     */
    public core.exolab.cst.mapping.xml.NamedQuery[] getNamedQuery()
    {
        int size = _namedQueryList.size();
        core.exolab.cst.mapping.xml.NamedQuery[] mArray = new core.exolab.cst.mapping.xml.NamedQuery[size];
        for (int index = 0; index < size; index++) {
            mArray[index] = (core.exolab.cst.mapping.xml.NamedQuery) _namedQueryList.get(index);
        }
        return mArray;
     ...
     * @return boolean
     */
    public boolean removeNamedQuery(core.exolab.cst.mapping.xml.NamedQuery vNamedQuery)
    {
     ...
     */
    public void setAccess(core.exolab.cst.mapping.xml.types.ClassMappingAccessType access)
    {
        this._access = access;
     ...
     */
    public void setCacheTypeMapping(core.exolab.cst.mapping.xml.CacheTypeMapping cacheTypeMapping)
    {
     ...
     */
    public void setClassChoice(core.exolab.cst.mapping.xml.ClassChoice classChoice)
    {
     ...
     */
    public void setMapTo(core.exolab.cst.mapping.xml.MapTo mapTo)
    {
        this._mapTo = mapTo;
     ...
     * @param vNamedQuery
     */
    public void setNamedQuery(int index, core.exolab.cst.mapping.xml.NamedQuery vNamedQuery)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        if ((index < 0) || (index >= _namedQueryList.size())) {
     ...
     */
    public void setNamedQuery(core.exolab.cst.mapping.xml.NamedQuery[] namedQueryArray)
    {
        //-- copy array
        _namedQueryList.clear();
     ...
     * @return ClassMapping
     */
    public static core.exolab.cst.mapping.xml.ClassMapping unmarshal(java.io.Reader reader)
        throws core.exolab.cst.xml.MarshalException, core.exolab.cst.xml.ValidationException
    {
        return (core.exolab.cst.mapping.xml.ClassMapping) Unmarshaller.unmarshal(core.exolab.cst.mapping.xml.ClassMapping.class, reader);
