 ...
 */
public class BindXmlNodeTypeDescriptor extends core.exolab.cst.xml.util.XMLClassDescriptorImpl {
    ...
    {
        return core.exolab.cst.mapping.xml.types.BindXmlNodeType.class;
