 ...
 */
public class ClassMappingAccessTypeDescriptor extends core.exolab.cst.xml.util.XMLClassDescriptorImpl {
    ...
    {
        return core.exolab.cst.mapping.xml.types.ClassMappingAccessType.class;
