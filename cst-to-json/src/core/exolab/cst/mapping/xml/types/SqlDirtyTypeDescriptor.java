 ...
 */
public class SqlDirtyTypeDescriptor extends core.exolab.cst.xml.util.XMLClassDescriptorImpl {
    ...
    {
        return core.exolab.cst.mapping.xml.types.SqlDirtyType.class;
