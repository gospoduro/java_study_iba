 ...
 * @since 1.1
 */
public class XercesJDK5Serializer implements core.exolab.cst.xml.Serializer {
    ...
    public XercesJDK5Serializer() {
        try {
            _serializer =  
            Class.forName(PACKAGE_NAME + ".XMLSerializer").newInstance();
        } catch (Exception except) {
            throw new RuntimeException(
                    Messages.format("conf.failedInstantiateSerializer", 
                            PACKAGE_NAME + ".XMLSerializer", except));
        }
    }
    
    /**
     * @see core.exolab.cst.xml.Serializer#setOutputCharStream(java.io.Writer)
     * {@inheritDoc}
     */
    ...
    /**
     * @see core.exolab.cst.xml.Serializer#asDocumentHandler()
     * {@inheritDoc}
     */
    ...
    /**
     * @see core.exolab.cst.xml.Serializer
     *      #setOutputFormat(core.exolab.cst.xml.OutputFormat)
     * {@inheritDoc}
     */
    public void setOutputFormat(final OutputFormat format) {
		...
		try {
			Class outputFormatClass =
				Class.forName(PACKAGE_NAME + ".OutputFormat");
			method = _serializer.getClass().getMethod(
    ...
    /**
     * @see core.exolab.cst.xml.Serializer#setOutputByteStream(java.io.OutputStream)
     * {@inheritDoc}
     */
